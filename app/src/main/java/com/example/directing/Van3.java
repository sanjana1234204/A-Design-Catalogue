...
public class Van3 extends Fragment
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.van_three, container, false);

        ImageView imageView=(ImageView) view.findViewById(R.id.iv2);

        tx = (TextView) view.findViewById(R.id.tv2);
        tx1 = (TextView) view.findViewById(R.id.tv22);

        f1 = (FloatingActionButton) view.findViewById(R.id.v7);
        f2 = (FloatingActionButton) view.findViewById(R.id.v8);

        myDataBase=new MyDataBase17(getActivity(),"vaninfo1",null,1);

        Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.van3);
