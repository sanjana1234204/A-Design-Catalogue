...
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void postDataToSQLite() {
       ...
       /* if (!databaseHelper.checkUser(textInputEditTextEmail.getText().toString().trim())) {
        ...
        if(textInputEditTextEmail.getText().toString().trim().equalsIgnoreCase(str))
        {
        ...
        {
            db.execSQL("INSERT INTO EMPLOYE(EmpName,EmpMail,EmpPass)VALUES('"+textInputEditTextName.getText()+"','"+textInputEditTextEmail.getText()+"','"+textInputEditTextPassword.getText()+"');");

            Toast.makeText(getApplicationContext(),"Registration successful, data inserted", Toast.LENGTH_SHORT).show();
        }
