...
public class Home2 extends Fragment
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ImageView imageView=(ImageView) view.findViewById(R.id.ih1);

        tx = (TextView) view.findViewById(R.id.th1);
        tx1 = (TextView) view.findViewById(R.id.th11);

        f1 = (FloatingActionButton) view.findViewById(R.id.h4);
        f2 = (FloatingActionButton) view.findViewById(R.id.h5);
