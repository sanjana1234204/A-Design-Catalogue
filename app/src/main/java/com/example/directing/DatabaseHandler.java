...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "contactManagers";

    // Contacts table name
    private static final String TABLE_CONTACTS = "contactts";
    ...
    public int updateContact(Contact contact, int no) {
        SQLiteDatabase db = this.getWritableDatabase();
