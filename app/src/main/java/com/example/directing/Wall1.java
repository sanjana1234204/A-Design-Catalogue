...
public class Wall1 extends Fragment
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.wall_one, container, false);

        ImageView imageView=(ImageView) view.findViewById(R.id.iw);

        tx = (TextView) view.findViewById(R.id.tw);
        tx1 = (TextView) view.findViewById(R.id.tww);

        f1 = (FloatingActionButton) view.findViewById(R.id.w1);
        f2 = (FloatingActionButton) view.findViewById(R.id.w2);

        myDataBase=new MyDataBase5(getActivity(),"wallinfo1",null,1);

        Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.wall1);
        ...
        String s1 = "Art Acrylic Wall Decorative Design\n\n" +
                "•\tWall Decor\n" +
                "•\t2 mm Acrylic\n" +
                "•\tShiny Finish\n" +
