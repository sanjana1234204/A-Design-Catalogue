...
public class Ceil3 extends Fragment
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.ceil_three, container, false);

        ImageView imageView=(ImageView) view.findViewById(R.id.ice2);

        tx = (TextView) view.findViewById(R.id.tce2);
        tx1 = (TextView) view.findViewById(R.id.tce22);

        f1 = (FloatingActionButton) view.findViewById(R.id.ce7);
        f2 = (FloatingActionButton) view.findViewById(R.id.ce8);

        myDataBase=new MyDataBase21(getActivity(),"ceilinfo",null,1);

        Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.ceil3);
        ...
        String s1 = "Product Specification\n\n" +
                "\n" +
                "Minimum Order Quantity:\t300 Square Feet\n" +
                "\n" +
                "Product Description\n\n" +
