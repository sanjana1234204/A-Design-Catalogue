...
public class Cab2 extends Fragment
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.cab_two, container, false);

        ImageView imageView=(ImageView) view.findViewById(R.id.ic1);

        tx = (TextView) view.findViewById(R.id.tc1);
        tx1 = (TextView) view.findViewById(R.id.tc11);

        f1 = (FloatingActionButton) view.findViewById(R.id.c4);
        f2 = (FloatingActionButton) view.findViewById(R.id.c5);

        myDataBase=new MyDataBase12(getActivity(),"cabinfo1",null,1);

        Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.cabinet2);
