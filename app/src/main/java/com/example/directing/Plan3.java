...
public class Plan3 extends Fragment
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.plan_three, container, false);

        ImageView imageView=(ImageView) view.findViewById(R.id.ip2);

        tx = (TextView) view.findViewById(R.id.tp2);
        tx1 = (TextView) view.findViewById(R.id.tp22);

        f1 = (FloatingActionButton) view.findViewById(R.id.p7);
        f2 = (FloatingActionButton) view.findViewById(R.id.p8);

        myDataBase=new MyDataBase11(getActivity(),"planinfo1",null,1);

        Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.plan3);
        ...
        String s1 ="Customize and Add Branding\n" +
