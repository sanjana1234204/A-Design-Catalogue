...
public class Ceil2 extends Fragment
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.ceil_two, container, false);

        ImageView imageView=(ImageView) view.findViewById(R.id.ice1);

        tx = (TextView) view.findViewById(R.id.tce1);
        tx1 = (TextView) view.findViewById(R.id.tce11);

        f1 = (FloatingActionButton) view.findViewById(R.id.ce4);
        f2 = (FloatingActionButton) view.findViewById(R.id.ce5);

        myDataBase=new MyDataBase21(getActivity(),"ceilinfo",null,1);

        Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.ceil2);
