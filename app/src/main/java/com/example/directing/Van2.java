...
public class Van2 extends Fragment
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.van_two, container, false);

        ImageView imageView=(ImageView) view.findViewById(R.id.iv1);

        tx = (TextView) view.findViewById(R.id.tv1);
        tx1 = (TextView) view.findViewById(R.id.tv11);

        f1 = (FloatingActionButton) view.findViewById(R.id.v4);
        f2 = (FloatingActionButton) view.findViewById(R.id.v5);

        myDataBase=new MyDataBase17(getActivity(),"vaninfo1",null,1);

        Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.van2);
        ...
        String s1 = "\tTiles from Ramacieri-Soligo brighten the bathroom, off the hall. But when it comes to modern bathroom vanities, gray, as seen here, is a popular choice. ";
