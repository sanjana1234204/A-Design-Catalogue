...
public class Diy3 extends Fragment
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.diy_three, container, false);

        ImageView imageView=(ImageView) view.findViewById(R.id.idy3);

        tx = (TextView) view.findViewById(R.id.tdy3);
        tx1 = (TextView) view.findViewById(R.id.tdy33);

        f1 = (FloatingActionButton) view.findViewById(R.id.dy7);
        f2 = (FloatingActionButton) view.findViewById(R.id.dy8);

        myDataBase=new MyDataBase19(getActivity(),"diyinfo1",null,1);

        Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.gidea3);
