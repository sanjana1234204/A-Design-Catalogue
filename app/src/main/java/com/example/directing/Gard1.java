...
public class Gard1 extends Fragment
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.gard_one, container, false);

        ImageView imageView=(ImageView) view.findViewById(R.id.ig);

        tx = (TextView) view.findViewById(R.id.tg);
        tx1 = (TextView) view.findViewById(R.id.tgg);

        f1 = (FloatingActionButton) view.findViewById(R.id.g1);
        f2 = (FloatingActionButton) view.findViewById(R.id.g2);

        myDataBase=new MyDataBase8(getActivity(),"gardinfo1",null,1);

        Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.garden1);
