...
public class Plan2 extends Fragment
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.plan_two, container, false);

        ImageView imageView=(ImageView) view.findViewById(R.id.ip1);

        tx = (TextView) view.findViewById(R.id.tp1);
        tx1 = (TextView) view.findViewById(R.id.tp11);

        f1 = (FloatingActionButton) view.findViewById(R.id.p4);
        f2 = (FloatingActionButton) view.findViewById(R.id.p5);

        myDataBase=new MyDataBase11(getActivity(),"planinfo1",null,1);

        Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.plan2);
